...
/**
 * Makes sure the class can call up an InfoWindow
 */
public interface InfoWindowMethods {

    void setInfoWindow(InfoWindow window);

    void showInfoWindow(String text, int x, int y);
